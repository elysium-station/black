...
HTTPS_GIT := https://github.com/Elysium-Station/black.git
...
format:
	...
	find . -name '*.go' -type f -not -path "./vendor*" -not -path "*.git*" -not -name '*.pb.go' | xargs goimports -w -local github.com/elysium-station/black
.PHONY: format
